...
if (isset($_COOKIE["auth"])) {
    $browseResponse = $hairLengthLink->browse();
    $hairLengthLinks = $browseResponse['hairLengthLinks'];
...
<div class="reveal large _table-modal" id="add-modal" data-reveal>
    ...
    <form action="hair_length_links.php" method="POST">
...
<div class="reveal large _table-modal" id="edit-modal" data-reveal>
    ...
    <form action="hair_length_links.php" method="POST" id="edit-form">
        <input type="hidden" name="token" value="<?=$token?>">
...
<div class="reveal large _table-modal" id="delete-modal" data-reveal>
    ...
    <form method="POST" action="hair_length_links.php">
        <input type="hidden" name="token" value="<?=$token?>">
