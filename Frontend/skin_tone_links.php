...
if ($_POST && Utils::verifyCSRFToken()) {
    if (isset($_POST['_method'])) {
        $alert = $skinToneLink->handleSubmit($_POST['_method']);
    } else {
        $alert = $skinToneLink->handleSubmit();
    }
}
...
<div class="reveal large _table-modal" id="add-modal" data-reveal>
    ...
    <form action="skin_tone_links.php" method="POST">
...
<div class="reveal large _table-modal" id="edit-modal" data-reveal>
    ...
    <form action="skin_tone_links.php" method="POST" id="edit-form">
        <input type="hidden" name="token" value="<?=$token?>">
...
<div class="reveal large _table-modal" id="delete-modal" data-reveal>
    ...
    <form method="POST" action="skin_tone_links.php">
        <input type="hidden" name="token" value="<?=$token?>">
